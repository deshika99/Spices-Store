...
<td><h1 align="center" style="color:#4E1371; font-family: Segoe, 'Segoe UI', 'DejaVu Sans', 'Trebuchet MS', Verdana, sans-serif;">Cart</h1></td>
<br>
<br>
...
<?php
$con=mysqli_connect("localhost","root","","spice store");
...
if(mysqli_num_rows($results)>0)
{
    ...
    <tr>
        <td>                        
            <img src= '".$row["path"]."' alt=' ' style='width:100px; height: 100px'>
        </td>
        <td>                            
            <p>".$row["id"]."</p>
        </td>
  ...
  <tbody>
    <tr>
      <td width="227" align="center"><a href="Store face Coustmer.php"><button type="submit" name="btnsubmit" id="subbtn">Back</button></a></td>
	    <td width="227" align="center"><a href="Store face Coustmer.php"><button type="submit" name="btnsubmit" id="subbtn">Continue </button></a></td>
    </tr>
  </tbody>
</table>
</a>
